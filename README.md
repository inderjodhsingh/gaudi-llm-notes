...
| [GLM-5.3-Flash-Uncensored-FP8](models/glm-5.3-flash/) | [paper](models/glm-5.3-flash/README.md) · [recipe](models/glm-5.3-flash/RECIPE.md) | **~17.7 tok/s** (TP=8, 8× Gaudi2, MoE + KDA/DSA hybrid, out-of-tree port; 742 tok/s at 128 concurrent; 192K context verified) |
